...
<body style="background-color: #ECECEC">
  ...
  <h1 style="color: red; text-align: center;">CURRENT GUJARAT STATE COVID-19 CASES DATA</h1>
  <div class="content" style="background-color: #ECECEC">
    ...
    <?php
          ...
          <div class='col-md-6' >
            <div class='card'>
              <div class='card-header'>
                <h3 class='card-title'>Cities of Gujarat</h3>
              </div>
              <!-- /.card-header -->
        ...
        foreach ($data1["Gujarat"]["districtData"] as $key => $value) {
           $str .= " <tr>
                      <td>" .$key."</td>
                      <td>".$data1["Gujarat"]["districtData"][$key]["confirmed"]."</td>
                      <td>".$data1["Gujarat"]["districtData"][$key]["recovered"]." 
                        
                      </td>
                      <td>".$data1["Gujarat"]["districtData"][$key]["deceased"]."</td>
                    </tr>";
        }
        $str .= "</tbody>
                </table>
